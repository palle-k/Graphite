#
#  Be sure to run `pod spec lint Graphite.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Graphite/*.{swift,h}"

  s.public_header_files = "Graphite/*.h"
